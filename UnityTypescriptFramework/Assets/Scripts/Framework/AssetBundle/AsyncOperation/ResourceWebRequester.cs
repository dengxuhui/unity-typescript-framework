...
namespace AssetBundles
{
    public class ResourceWebRequester : ResourceAsyncOperation
    {
        ...
        protected UnityWebRequest uwr = null;
        ...
        public void Init(string name, string url, bool noCache = false, bool ab = false, int timeout = 0)
        {
        ...
        public bool isAssetbundleVaild => uwr != null;
        public AssetBundle assetbundle => DownloadHandlerAssetBundle.GetContent(uwr);
        ...
        public string error
        {
            get
            {
                ...
                return (uwr == null || string.IsNullOrEmpty(uwr.error)) ? null : uwr.error;
            }
        }
        ...
        public override float Progress()
        {
            ...
            return uwr?.downloadProgress ?? 0f;
        }
        ...
        public override void Update()
        {
            ...
            isOver = uwr != null && (uwr.isDone || !string.IsNullOrEmpty(uwr.error));
            if (!isOver)
            {
                return;
            }
